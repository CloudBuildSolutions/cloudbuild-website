...
type CloudBuildWebFrontEndStackProps = cdk.StackProps & {
  config: Readonly<ConfigProps>
}

export class CloudBuildWebFrontEndStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props: CloudBuildWebFrontEndStackProps) {
